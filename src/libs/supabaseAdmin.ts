...
const createOrRetrieveACustomer = async ({
  ...
  if(error || !data?.stripe_customer_id) {
    ...
    console.log(`New customer crated and inserted for ${uuid}`)
    return customer.id
  }
...
const manageSubsciptionStatusChange = async (
  ...
  console.log(`Inserted/Updated subsription [${subscription.id} for ${uuid}]`)
